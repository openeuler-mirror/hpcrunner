...
./configure --prefix=$1 ${build_type} --enable-fortran --enable-static=yes --enable-parallel --disable-shared CFLAGS="-O3 -fPIC -Wno-incompatible-pointer-types-discards-qualifiers -Wno-non-literal-null-conversion" FCFLAGS="-O3 -fPIC"
