...
set -e
hmpi_version='2.4.2'
. ${DOWNLOAD_TOOL} -u https://gitee.com/kunpengcompute/hucx/repository/archive/v2.4.2-huawei.tar.gz -f hucx-${hmpi_version}-huawei.tar.gz
. ${DOWNLOAD_TOOL} -u https://gitee.com/kunpengcompute/xucg/repository/archive/v2.4.2-huawei.tar.gz -f xucg-${hmpi_version}-huawei.tar.gz
. ${DOWNLOAD_TOOL} -u https://gitee.com/kunpengcompute/hmpi/repository/archive/v2.4.2-huawei.tar.gz -f hmpi-${hmpi_version}-huawei.tar.gz
cd ${JARVIS_TMP}
