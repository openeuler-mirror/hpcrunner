...
REG_META_HVALUE=$(md5sum ${JARVIS_DOWNLOAD}/Anaconda3-2024.10-1-Linux-aarch64.sh| awk '{print $1}')
REG_META_HTYPE="md5"
REG_META_PACKAGE="Anaconda3-2024.10-1-Linux-aarch64.sh"
REG_META_TYPE="sh"

cd ${JARVIS_DEV_VROOT}/Anaconda3/${BASENAME}

bash ${JARVIS_DOWNLOAD}/Anaconda3-2024.10-1-Linux-aarch64.sh -u -b -p ${PATH_INSTALL}
