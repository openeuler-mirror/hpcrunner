...
#	 stage=1001 -->
T "f_deepmdkit" 1 "deepmdkit"		T "f_abinit" 1 "abinit"
)

### 20251106 test ok all
fi 
...
T "f_scalapack" 1 "scalapack"		T "f_boost" 1 "boost"			T "f_kml" 1 "kml"			T "f_lapack" 1 "lapack"
###															#<-- stage=4201
T "f_blas" 1 "blas"			T "f_openblas" 1 "openblas"		T "f_jdk" 1 "jdk"			T "f_abinit" 1 "abinit"	
T "f_obspy" 1 "obspy"			T "f_sqlite" 1 "sqlite"			T "f_snappy" 1 "snappy"		T "f_gribapi" 1 "gribapi"
T "f_openmpi" 1 "openmpi"		T "f_singu" 1 "singu"			T "f_gdal" 1 "gdal"			T "f_megahit" 1 "megahit"
)
### 02251106 f_abinit ok for kgcc,no bisheng
callback_entry() {
    local callback=$1
    local d1=$2
    local d2=$3
...
cp templates/${BCH}/openfoa/dataconfig_patches . -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
cp templates/${BCH}/specfem3d/4.1.1/dataconfig_patches ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/pytorch/2.5.1/data.config data.config -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/abinit/9.8.4/data_kgcc12.3.1.config data.config  ./ -ar
cp templates/${BCH}/abinit/9.8.4/dataconfig_patches ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/obspy/1.4.2/data.config ./ -ar
cp templates/${BCH}/obspy/1.4.2/dataconfig_patches ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/sqlite/3.46.0/data.config ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/snappy/1.2.0/data.config ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/grib_api/1.21.0/data.config ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/openmpi/4.1.2/data.config  ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/singularity/3.9.9/data.config  ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/gdal/3.9.0/data.config  ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
...
local LOGDIR=$3
echo "${TOKEN}"
cp templates/${BCH}/megahit/1.2.9/data.config  ./ -ar
cp templates/${BCH}/megahit/1.2.9/dataconfig_patches ./ -ar
dotask ${TOKEN} ${TIME} ${LOGDIR} ${LINENO}
return 0
}
